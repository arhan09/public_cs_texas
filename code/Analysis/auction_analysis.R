...
# quite the same as the relationship between reserves and date/county
# 2) still, the fit isn't terrible
# 3) because slopes on u and hetindex in the bid model are nearly identical and
