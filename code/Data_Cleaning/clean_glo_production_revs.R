# based off of the original clean_glo_production_revs.R
# this one *just* reads in the royalty payment data and does no grossing up,
# discounting, or anything else

# may someday supersede the original
#===========================================================================
# BASIC TEXAS SETUP
#===========================================================================
root = getwd()
