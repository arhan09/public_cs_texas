...
$(TDIR)/everleased.tex $(TDIR)/parcel_regressions.tex \
...
$(TDIR)/auction_number_bids.tex $(TDIR)/TopPairAuctionShares.tex \
	...
	$(EDIR)/tract_date_count.tex $(EDIR)/tract_date_leased.tex \
...
$(PAPER).pdf: $(PAPER).tex $(PAPER).bib \
	...
	$(EDIR)/dboe_min.tex \
	$(EDIR)/dboe_max.tex \
	$(EDIR)/poisson_output_min.tex \
	$(EDIR)/poisson_output_max.tex \
	...
	$(EDIR)/tract_date_leased_share.tex \
	$(EDIR)/tract_ever_leased_share.tex \
	$(EDIR)/negotiation_ever_leased.tex \
	$(TDIR)/everleased.tex \
